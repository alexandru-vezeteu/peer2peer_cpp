...
array<uint8_t, 16> poly_1305::generate(
...
)
{
    ...
    {
        size_t block_len = min(msg.size() - offset, size_t(16));

        array<uint8_t, 17> block{};
...
bool poly_1305::verify(
    span<const uint8_t> key,
    span<const uint8_t> msg,
    span<const uint8_t> provided_tag)
{
